...
class Newest extends \Magento\Backend\Block\Dashboard\Grid
{
     ...
     * @param \Magento\ReportingFramework\Model\ResourceModel\Customer\CollectionFactory $collectionFactory
     * @param array $data
     */
    public function __construct(
        \Magento\Backend\Block\Template\Context $context,
        \Magento\Backend\Helper\Data $backendHelper,
        \Magento\ReportingFramework\Model\ResourceModel\Customer\CollectionFactory $collectionFactory,
        array $data = []
    ) {
