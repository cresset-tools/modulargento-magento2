 ...
 */
namespace Magento\ReviewReports\Block\Adminhtml\Review\Detail;
...
{
    /**
     * @var \Magento\ReviewReports\Model\ResourceModel\Review\CollectionFactory
     */
     ...
     * @param \Magento\ReviewReports\Model\ResourceModel\Review\CollectionFactory $reviewsFactory
     * @param array $data
     */
    public function __construct(
        \Magento\Backend\Block\Template\Context $context,
        \Magento\Backend\Helper\Data $backendHelper,
        \Magento\ReviewReports\Model\ResourceModel\Review\CollectionFactory $reviewsFactory,
        array $data = []
    ) {
